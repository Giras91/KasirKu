package com.extropos.java.widget;
...
import com.extropos.java.printer.PrinterOptions;
...
public class CustomConfirm extends Dialog implements android.view.View.OnClickListener{
    ...
    private void print()
    {
        ...
        p.newLine();
        p.setText(context.getString(R.string.receipt_phone) + Shared.read(Constants.KEY_SETTING_STORE_PHONE,Constants.VAL_DEFAULT_STORE_PHONE));
        p.newLine();
        p.newLine();
        p.alignLeft();
        ...
        p.addDoubleLineSeperator();
        p.setText(Shared.printerLeftRight(context.getString(R.string.receipt_subtotal),Shared.decimalformat.format(subtotal)));
        p.newLine();
        p.setText(Shared.printerLeftRight(context.getString(R.string.receipt_discount),Shared.decimalformat.format(disc)));
        p.newLine();
        p.setText(Shared.printerLeftRight(context.getString(R.string.receipt_total),Shared.decimalformat.format(subtotal - disc)));
        p.newLine();
        p.alignCenter();
        p.newLine();
